...
func main() {
	...
	if !*noop {
		...
		loggingClient = loginsight.NewForwarder(*logInsightServer, *logInsightServerPort, *logInsightReservedFields, *logInsightAgentID, *logInsightHasJSONLogMsg, *debug, *concurrentWorkers, *maxIdleConnections, *maxIdleConnectionsPerHost, *idleConnectionTimeoutSeconds)
	} else {
